...
export class Publisher
{
    ...
    async publish(scriptData?: ScriptData): Promise<Script>
    {
        ...
        {
           console.log(`Publisher.publish(): Script ${scriptData.author}/${scriptData.name} already exists in the library with version ${latestScriptInLibrary.published?.version}`);
        }
