...
// constants
import { FACE_CIRCLE_RADIUS, FACE_PLANE_WIDTH, FACE_PLANE_DEPTH } from '.'
...
import type { PointLike, Cursor, AnyShape, SketchPlaneName, PointLikeSequence, 
    ...
    AnyShapeOrCollectionOrSelectionString } from '.'

import { isPointLike, isAnyShape, isSelectionString, isSketchPlaneName } from '.' // typeguards

import { Point, Vector, ShapeCollection, VertexCollection, Vertex, Edge, Wire, Face, Brep } from '.'
