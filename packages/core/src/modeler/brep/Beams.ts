...
import { isBeamBaseLineAlignment, isPointLike, isNumeric } from '.' // typeguards

import { Point, Vector, Shape, Vertex, Edge, Wire, Face, Shell, Solid, ShapeCollection } from '.'
import { uuidv4, toRad }  from '.'
