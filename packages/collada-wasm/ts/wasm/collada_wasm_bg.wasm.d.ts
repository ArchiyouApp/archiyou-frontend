...
export const colladawriter_new: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => number;
export const colladawriter_toStringDae: (a: number) => [number, number, number, number];
